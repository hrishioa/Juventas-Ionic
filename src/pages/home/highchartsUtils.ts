...
export const glucoseGraphTheme = {
...
export const glucoseGaugeTheme = {
   ...
   H.addEvent(H.Axis, 'afterInit', function() {
      ...
      if (!this.isXAxis) {
         H.wrap(this, 'getPlotBandPath', function(p) {
            var originalShape = p.apply(this, Array.prototype.slice.call(arguments, 1)),
            indexL = originalShape.indexOf('L'),
            indexZ;
